...
import { MaxNumberFieldRule, maxNumberRuleExplanation } from '../field-rules/prepared/numbers-related/max-number.field-v-rule';
import { EmailFormatFieldRule } from '../field-rules/prepared/strings-related/email-format.field-v-rule';
import { maxCharsCountRuleExplanation, MaxCharsCountFieldRule } from '../field-rules/prepared/strings-related/max-chars-count.field-v-rule';
import { minCharsCountRuleExplanation, MinCharsCountFieldRule } from '../field-rules/prepared/strings-related/min-chars-count.field-v-rule';
...
describe('Тестирование валидатора', () => {
  describe('Тестирование валидации литерального значения', () => {
    ...
    class LiteralValidator extends Validator<ValidatableLiteral> {
      validatorMap = new LiteralFieldValidator({
        ...
        rules: [
          new MaxNumberFieldRule(maxNumber),
        ],
      });
    }
  ...
  describe('Тестирование валидации массива литеральных значений', () => {
    ...
    class LiteralArrayValidator extends Validator<ValidatableLiteralArray> {
      validatorMap = new LiteralFieldValidator({
        ...
        rules: [
          new MinCharsCountFieldRule(minChars),
        ],
      });
    }
          ...
          typeConfig: {
            ...
            validatorMap: {
              ...
              emails: new LiteralFieldValidator({
                ...
                typeConfig: { type: 'string' },
                rules: [new EmailFormatFieldRule()],
              }),
          ...
          typeConfig: {
            ...
            validatorMap: {
              realName: new LiteralFieldValidator({
                ...
                arrayConfig: { isArray: false },
                typeConfig: { type: 'string' },
                rules: [new MinCharsCountFieldRule(minCharsCount)],
              }),
            },
          },
        });
  ...
  describe('Валидация чего-либо неподдерживаемого: ошибка NonValidatableFieldRule', () => {
  ...
  describe('Нарушение нескольких правил валидации', () => {
    ...
    class LiteralArrayValidator extends Validator<ValidatableLiteralArray> {
      validatorMap = new LiteralFieldValidator({
        ...
        rules: [
          new MinCharsCountFieldRule(minChars),
          new MaxCharsCountFieldRule(maxChars),
        ],
      });
    }
